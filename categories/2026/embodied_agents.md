...
- [Interaction-Centered Intelligence: Toward an Interaction-Based Theory of Human-AI Co-Creation](http://arxiv.org/abs/2606.00807v2)
  Nicholas Davis
  Code: nan
- [MineExplorer: Evaluating Open-World Exploration of MLLM Agents in Minecraft](http://arxiv.org/abs/2605.30931v3)
  Tianjie Ju, Yueqing Sun, Zheng Wu, Wei Zhang, Yaqi Huo, Xi Su, Qi Gu, Xunliang Cai, Gongshen Liu, Zhuosheng Zhang
  Code: https://github.com/meituanlongcat/MineExplorer
- [SalsaAgent: A multimodal embodied language model for interactive dance generation](http://arxiv.org/abs/2605.29219v3)
...
- [Neuro-Symbolic Strong-AI Robots with Closed Knowledge Assumption: Learning and Deductions](http://arxiv.org/abs/2604.09567v2)
  Zoran Majkic
  Code: nan
- [Adaptive-Horizon Conflict-Based Search for Closed-Loop Multi-Agent Path Finding](http://arxiv.org/abs/2602.12024v2)
  Jiarui Li, Federico Pecora, Runyu Zhang, Gioele Zardini
  Code: nan
- [From Legible to Inscrutable Trajectories: (Il)legible Motion Planning Accounting for Multiple Observers](http://arxiv.org/abs/2602.09227v2)
...
- [Beware Untrusted Simulators -- Reward-Free Backdoor Attacks in Reinforcement Learning](http://arxiv.org/abs/2602.05089v3)
  ...
  Code: nan
- [Relational Scene Graphs for Object Grounding of Natural Language Commands](http://arxiv.org/abs/2602.04635v2)
  Julia Kuhn, Francesco Verdoja, Tsvetomila Mihaylova, Ville Kyrki
  Code: nan
- [Bandwidth-Efficient Multi-Agent Communication through Information Bottleneck and Vector Quantization](http://arxiv.org/abs/2602.02035v2)
  Ahmad Farooq, Kamran Iqbal
  Code: nan

## January

- [Constrained Meta Reinforcement Learning with Provable Test-Time Safety](http://arxiv.org/abs/2601.21845v2)
  Tingting Ni, Maryam Kamgarpour
  Code: nan
- [From Digital to Physical: Digital Agents as Autonomous Coaches for Physical Intelligence](http://arxiv.org/abs/2601.21570v2)
  ...
  Code: nan
- [Bounded Normative Equivalence in Human-AI Cooperation: Group Behaviour, Not Partner Labels, Predicts Cooperation under Anonymous Aggregate Feedback](http://arxiv.org/abs/2601.20487v3)
