...
- [HiF-VLA: Hindsight, Insight and Foresight through Motion Representation for Vision-Language-Action Models](http://arxiv.org/abs/2512.09928v2)
  ...
  Code: nan
- [Radiance-Field Guided Pretraining: Scaling Localization Models with Unlabeled Wireless Signals](http://arxiv.org/abs/2512.07309v2)
...
- [WorldPack: Dynamic Frame Compression for Long-context Video World Modeling](http://arxiv.org/abs/2512.02473v2)
  ...
  Code: nan
- [WorldPack: Dynamic Frame Compression for Long-context Video World Modeling](http://arxiv.org/abs/2512.02473v3)
  Yuta Oshima, Yusuke Iwasawa, Masahiro Suzuki, Yutaka Matsuo, Hiroki Furuta
  Code: nan
...
- [Seeing the Bigger Picture: 3D Latent Mapping for Mobile Manipulation Policy Learning](http://arxiv.org/abs/2510.03885v3)
  ...
  Code: nan
- [Compose Your Policies! Improving Diffusion-based or Flow-based Robot Policies via Test-time Distribution-level Composition](http://arxiv.org/abs/2510.01068v2)
...
- [UniDomain: Pretraining a Unified PDDL Domain from Real-World Demonstrations for Generalizable Robot Task Planning](http://arxiv.org/abs/2507.21545v3)
  ...
  Code: nan
- [Assistax: A Multi-Agent Hardware-Accelerated Reinforcement Learning Benchmark for Assistive Robotics](http://arxiv.org/abs/2507.21638v3)
  ...
  Code: https://github.com/assistive-autonomy/assistax
...
- [ViTaPEs: Visuotactile Position Encodings for Cross-Modal Alignment in Multimodal Transformers](http://arxiv.org/abs/2505.20032v3)
  Fotios Lygerakis, Ozan Özdenizci, Elmar Rückert
  Code: nan
- [DreamPolicy: A Unified World-model Policy for Scalable Humanoid Locomotion](http://arxiv.org/abs/2505.18780v3)
...
- [SharedAssembly: A Data Collection Approach via Shared Tele-Assembly](http://arxiv.org/abs/2503.12287v2)
